        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <?php
                        $access_way = 'WEB';
                        if(!empty($_SESSION['user_data']['access_way']))
                            $access_way = $_SESSION['user_data']['access_way'];
                        
                    ?>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Último acceso <?php echo $_SESSION['user_data']['last_access'].' | '.$access_way;?><b class="caret"></b>
                    </a>
